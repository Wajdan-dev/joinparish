...
export const HeroSection = () => {
    return (
        <div className='bg-transparent' style={{ backgroundImage: 'linear-gradient(180deg, #0451B0 44%, #0451B0 100%)' }}>
            <div className="max-w-[1280px] mx-auto pt-[30px] pb-[30px] lg:pb-0 px-[15px] lg:px-0 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-[40px]  ">
                    <div className='flex flex-col gap-[30px]'>
                        ...
                        <div className="px-[16px] hidden lg:block border border-white rounded-[24px] w-[99px] text-center">
                    ...
                    <div>
                        <Image src='/images/Tiger-Comm-Services.webp' width={1000} height={1000} className='w-full h-auto max-w-full' alt='' />
