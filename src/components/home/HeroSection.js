...
export const HeroSection = () => {
    ...
    return (
        <div className='bg-transparent' style={{ backgroundImage: 'linear-gradient(180deg, #0451B0 44%, #0451B0 100%)' }}>
            <div className="max-w-[1280px] mx-auto py-[100px]     px-[15px] lg:px-0 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-[40px]  ">
                    <div className='flex flex-col gap-[30px]'>
                        <h1 data-aos-duration="1000" data-aos="fade-up" className='lg:text-[73px] text-[45px] text-center lg:text-start font-semibold text-white'>
                        ...
                        <button data-aos-duration="1000" data-aos="fade-up" className='bg-white hidden   text-[#2d2d2d] text-[18px] rounded-[36px] px-[50px] py-[20px] font-semibold w-[219px] lg:flex gap-2 justify-center '>
                            Learn More
                        </button>
                    </div>
