    ...
    >
      ...
      <div className="max-w-[1280px] mx-auto py-[100px] px-[15px] lg:px-0 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-[40px]">
          ...
          <div>
            <Image src='/images/parish-banner.png' width={1000} height={1000} className='w-full h-auto object-contain lg:h-[520px] lg:object-cover max-w-[520px]   lg:ml-auto' alt='' />
